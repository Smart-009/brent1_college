...
-- Allow everyone to read published subjects, courses, and lessons
...
-- 2. Seed All 12 Accredited College Subjects
...
-- 3. Seed College Faculty & Admin Profiles if not present
INSERT INTO profiles (id, full_name, admission_number, role, is_active)
VALUES
  ('40bcf126-5fa0-4df1-be4b-480088ce315a', 'Eclat Institute Principal & Administrator', 'Eclat2026@admin', 'admin', true),
  ('a0000000-0000-0000-0000-000000000001', 'Faculty Instructor', 'FAC-001', 'teacher', true)
ON CONFLICT (id) DO UPDATE SET full_name = EXCLUDED.full_name, role = EXCLUDED.role;

-- 4. Seed All 12 Accredited Courses
INSERT INTO courses (id, title, description, subject_id, teacher_id, is_published)
VALUES
  ('22222222-2222-2222-2222-222222222201', 'Full-Stack Web Development & Modern JavaScript', '100% Online: Master React 19, Node.js APIs, PostgreSQL database architecture, and cloud deployment.', '11111111-1111-1111-1111-111111111101', 'a0000000-0000-0000-0000-000000000001', true),
  ('22222222-2222-2222-2222-222222222202', 'Python Programming, SQL & Data Analytics', '100% Online: Python data analysis, Pandas, SQL relational queries, and automated data visualization.', '11111111-1111-1111-1111-111111111102', 'a0000000-0000-0000-0000-000000000001', true),
  ('22222222-2222-2222-2222-222222222203', 'Comprehensive Computer Packages & Digital Literacy', '100% Online: Ms Word, Excel Pro, PowerPoint presentations, Google Workspace, speed typing & Canva graphics.', '11111111-1111-1111-1111-111111111103', 'a0000000-0000-0000-0000-000000000001', true),
  ('22222222-2222-2222-2222-222222222204', 'Cybersecurity Fundamentals & Ethical Defense', '100% Online: Threat detection, network security defense, password hashing, encryption & risk assessment.', '11111111-1111-1111-1111-111111111104', 'a0000000-0000-0000-0000-000000000001', true),
  ('22222222-2222-2222-2222-222222222205', 'Computerized Accounting, QuickBooks & KRA iTax', '100% Online: QuickBooks Pro, monthly KRA iTax filing (VAT, PAYE), payroll computations & financial balance sheets.', '11111111-1111-1111-1111-111111111105', 'a0000000-0000-0000-0000-000000000001', true),
  ('22222222-2222-2222-2222-222222222206', 'English Language & IELTS Academic / General Prep', '100% Online: Spoken English fluency, business correspondence, IELTS 7.5+ band strategies & exam preparation.', '11111111-1111-1111-1111-111111111106', 'a0000000-0000-0000-0000-000000000001', true),
  ('22222222-2222-2222-2222-222222222207', 'Digital Marketing, Social Media & Content Creation', '100% Online: Meta Ads, TikTok & Instagram growth, SEO ranking, Google Ads, email funnels & influencer monetization.', '11111111-1111-1111-1111-111111111107', 'a0000000-0000-0000-0000-000000000001', true),
  ('22222222-2222-2222-2222-222222222208', 'Graphics Design & Animation', 'Comprehensive online course in Graphics Design & Animation covering Canva, Adobe Photoshop, Illustrator, and motion graphics.', '11111111-1111-1111-1111-111111111108', 'a0000000-0000-0000-0000-000000000001', true),
  ('22222222-2222-2222-2222-222222222209', 'French Language for Beginners & DELF Prep', '100% Online: Spoken French, listening comprehension, grammar, and international DELF examination prep.', '11111111-1111-1111-1111-111111111109', 'a0000000-0000-0000-0000-000000000001', true),
  ('22222222-2222-2222-2222-222222222210', 'German Language for Work & Studies (Goethe Prep)', '100% Online: German grammar, conversational fluency, Goethe-Zertifikat A1/A2 preparation for work & university.', '11111111-1111-1111-1111-111111111110', 'a0000000-0000-0000-0000-000000000001', true),
  ('22222222-2222-2222-2222-222222222211', 'Arabic Language & Islamic Calligraphy Basics', '100% Online: Modern Standard Arabic, conversational reading, vocabulary & Arabic calligraphy foundations.', '11111111-1111-1111-1111-111111111111', 'a0000000-0000-0000-0000-000000000001', true),
  ('22222222-2222-2222-2222-222222222212', 'Kiswahili Sanifu & East African Business Fluency', '100% Online: Spoken Swahili fluency, business negotiations, translation & East African trade communication.', '11111111-1111-1111-1111-111111111112', 'a0000000-0000-0000-0000-000000000001', true)
ON CONFLICT (id) DO UPDATE SET title = EXCLUDED.title, description = EXCLUDED.description;

-- 5. Seed Core Video Lessons
INSERT INTO lessons (id, course_id, title, description, youtube_url, order_index)
VALUES
