              ...
              <div className="modal-body" style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                    ...
                    <select
                      ...
                      onChange={(e) => {
                        ...
                        if (std) {
                          ...
                          const fee = existingInv ? existingInv.balance : (std.fee_balance || 15000)
                          setPaymentData({
                            ...paymentData,
                            student_id: std.id,
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        const fee = existingInv ? existingInv.balance : (std ? std.fee_balance || 15000 : paymentData.total_fee)
                        setPaymentData({
                          ...paymentData,
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                  <div>
                    ...
                    >
                      <option value="M-Pesa">M-Pesa Paybill (247247)</option>
